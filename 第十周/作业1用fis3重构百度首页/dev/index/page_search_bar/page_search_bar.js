	...
	module.exports = {		
		render:function(container){
			...
			theme.addNoThemeObserver(function(){
				$("#page_search_bar .logo img").attr("src",__uri("./index/page_search_bar/img/logo_color.png"));
			...
			theme.addUseThemeObserver(function(){
				$("#page_search_bar .logo img").attr("src",__uri("./index/page_search_bar/img/logo_white.png"));
