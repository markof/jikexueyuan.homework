define(function (require, exports, module) {
    ...
    module.exports = {
        renderNew: function (target) {
            ...
            // 初始化新闻各个框的内容
            $(mycontainer.selector + " .addnewsmodal .news_title").html("");
    ...
    // 提交新闻
    function submitNews() {
        postData.title = $(mycontainer.selector + " .addnewsmodal .news_title").html();
    ...
    function renderCatList(data) {
        ...
        $(mycontainer.selector + " .addnewsmodal .category_list li").on("click", function () {
            $(mycontainer.selector + " .addnewsmodal .news_cat").html($($(this).children()[0]).html());
    ...
    function renderNews(data) {
        $.each(data.queryResult, function (index, item) {
            $(mycontainer.selector + " .addnewsmodal .news_title").html(item.title);
