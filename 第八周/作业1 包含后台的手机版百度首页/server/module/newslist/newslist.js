        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.queryResult,function(index, item){
                    $('<tr><td><a class="newsModify" href="#" data-id="'+ item.id +'">'+ item.title +'<a></td><td>'+ item.cat_title +'</td><td>'+ item.modifydate +'</td><td><a data-id='+ item.id +' class="newsDelete" href="#">删除</a></td></tr>').appendTo(container.selector +" .newslist_allnews");
                });
